#ifndef LAMBDA_VISITOR_HPP_7RKEUSU1
#define LAMBDA_VISITOR_HPP_7RKEUSU1

// Stolen from http://www.baryudin.com/blog/boost-variant-and-lambda-functions-c-11.html
...
template <typename ReturnT> struct lambda_visitor<ReturnT> : public boost::static_visitor<ReturnT> {
...
#endif /* end of include guard: LAMBDA_VISITOR_HPP_7RKEUSU1 */
