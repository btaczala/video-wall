...
namespace mars {
namespace webengine {
BrowserClient::BrowserClient(CefRefPtr<CefRenderHandler> ptr) : _handler(ptr) {}
...
void BrowserClient::OnLoadError(CefRefPtr<CefBrowser> browser,
    ...
    mars_debug_(ui, "OnLoadError({},{},{},{},{})", static_cast<void*>(browser.get()),
               static_cast<void*>(frame.get()), errorCode, errorText.ToString(),
               failedUrl.ToString());
}
...
void BrowserClient::OnLoadingStateChange(CefRefPtr<CefBrowser> browser,
                                         ...
                                         bool canGoForward) {
    mars_debug_(ui, "OnLoadingStateChange({}, {}, {}, {})", static_cast<void*>(browser), isLoading, canGoBack, canGoForward);
}
