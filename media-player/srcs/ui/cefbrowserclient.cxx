...
namespace webengine {
        ...
        const CefString& errorText, const CefString& failedUrl)
    {
        mars_debug_(ui, "OnLoadError({},{},{},{},{})", static_cast<void*>(browser.get()),
            static_cast<void*>(frame.get()), errorCode, errorText.ToString(), failedUrl.ToString());
    }

    void BrowserClient::OnLoadingStateChange(
        CefRefPtr<CefBrowser> browser, bool isLoading, bool canGoBack, bool canGoForward)
    {
        mars_debug_(ui, "OnLoadingStateChange({}, {}, {}, {})", static_cast<void*>(browser), isLoading, canGoBack,
            canGoForward);
    }
