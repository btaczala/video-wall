...
bool RenderHandler::GetViewRect(CefRefPtr<CefBrowser> browser, CefRect& rect) {
    rect = CefRect(0, 0, _renderingTexture->size().first,
                   _renderingTexture->size().second);
    return true;
}
...
void RenderHandler::OnPaint(CefRefPtr<CefBrowser> browser,
    ...
    mars_trace_(ui, "OnPaint({}, {}, {}, {}, {}, {}", static_cast<void*>(browser),
               type, dirtyRects.size(), static_cast<const void* > (buffer), w, h);
